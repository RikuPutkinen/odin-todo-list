...
var _logicStuff = require("./modules/logicStuff");
...
const projects = _logicStuff.loadStorage("todoProjects") || [];
let selectedProjectId = _logicStuff.loadStorage("todoSelectedProjectId") || null;
let selectedTodoId = _logicStuff.loadStorage("todoSelectedTodoId") || null;
let selectedProject;
let selectedTodo;
...
function renderProjectView(projectId) {
    ...
    selectedProject = projects[_logicStuff.findIndexById(projects, projectId)];
...
function saveProject() {
    ...
    projects[_logicStuff.findIndexById(projects, selectedProjectId)] = selectedProject;
    _logicStuff.updateStorage("todoProjects", projects);
    renderPage();
}
...
newProjectButton.addEventListener("click", ()=>{
    _logicStuff.createProject(projects);
    renderProjectList();
});
...
},{"./modules/logicStuff":"6pH0W"}],"6pH0W":[function(require,module,exports) {
...
const idGenerator = (0, _generators.idGeneratorFunction)(latestId);
const newId = ()=>{
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "idGeneratorFunction", ()=>idGeneratorFunction);
...
},{"../_lib/defaultOptions/index.js":"dWs8l","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dWs8l":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire3566")
